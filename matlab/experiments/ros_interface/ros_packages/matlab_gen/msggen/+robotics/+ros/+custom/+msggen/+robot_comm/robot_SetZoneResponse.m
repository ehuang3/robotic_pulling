classdef robot_SetZoneResponse < robotics.ros.Message
    %robot_SetZoneResponse MATLAB implementation of robot_comm/robot_SetZoneResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetZoneResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_SetZoneResponse(msg)
            %robot_SetZoneResponse Construct the message object robot_SetZoneResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetZoneResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'robot_SetZoneResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetZoneResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetZoneResponse;
            obj.reload(strObj);
        end
    end
end
