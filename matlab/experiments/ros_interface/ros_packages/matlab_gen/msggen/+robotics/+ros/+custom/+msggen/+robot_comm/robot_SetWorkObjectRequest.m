classdef robot_SetWorkObjectRequest < robotics.ros.Message
    %robot_SetWorkObjectRequest MATLAB implementation of robot_comm/robot_SetWorkObjectRequest
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetWorkObjectRequest' % The ROS message type
    end
    ...
    methods
        function obj = robot_SetWorkObjectRequest(msg)
            %robot_SetWorkObjectRequest Construct the message object robot_SetWorkObjectRequest
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetWorkObjectRequest', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetWorkObjectRequest', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetWorkObjectRequest', 'Z');
        ...
        function set.Q0(obj, q0)
            ...
            validateattributes(q0, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetWorkObjectRequest', 'Q0');
        ...
        function set.Qx(obj, qx)
            ...
            validateattributes(qx, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetWorkObjectRequest', 'Qx');
        ...
        function set.Qy(obj, qy)
            ...
            validateattributes(qy, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetWorkObjectRequest', 'Qy');
        ...
        function set.Qz(obj, qz)
            ...
            validateattributes(qz, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetWorkObjectRequest', 'Qz');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetWorkObjectRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetWorkObjectRequest;
            obj.reload(strObj);
        end
    end
end
