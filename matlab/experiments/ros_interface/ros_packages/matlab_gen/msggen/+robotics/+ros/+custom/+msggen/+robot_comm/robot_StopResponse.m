classdef robot_StopResponse < robotics.ros.Message
    %robot_StopResponse MATLAB implementation of robot_comm/robot_StopResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_StopResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_StopResponse(msg)
            %robot_StopResponse Construct the message object robot_StopResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_StopResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'robot_StopResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_StopResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_StopResponse;
            obj.reload(strObj);
        end
    end
end
