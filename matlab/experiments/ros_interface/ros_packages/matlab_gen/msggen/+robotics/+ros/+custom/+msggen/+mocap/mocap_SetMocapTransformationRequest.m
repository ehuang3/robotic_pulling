classdef mocap_SetMocapTransformationRequest < robotics.ros.Message
    %mocap_SetMocapTransformationRequest MATLAB implementation of mocap/mocap_SetMocapTransformationRequest
    ...
    properties (Constant)
        MessageType = 'mocap/mocap_SetMocapTransformationRequest' % The ROS message type
    end
    ...
    methods
        function obj = mocap_SetMocapTransformationRequest(msg)
            %mocap_SetMocapTransformationRequest Construct the message object mocap_SetMocapTransformationRequest
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetMocapTransformationRequest', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetMocapTransformationRequest', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetMocapTransformationRequest', 'Z');
        ...
        function set.Q0(obj, q0)
            ...
            validateattributes(q0, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetMocapTransformationRequest', 'Q0');
        ...
        function set.Qx(obj, qx)
            ...
            validateattributes(qx, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetMocapTransformationRequest', 'Qx');
        ...
        function set.Qy(obj, qy)
            ...
            validateattributes(qy, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetMocapTransformationRequest', 'Qy');
        ...
        function set.Qz(obj, qz)
            ...
            validateattributes(qz, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetMocapTransformationRequest', 'Qz');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mocap.mocap_SetMocapTransformationRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mocap.mocap_SetMocapTransformationRequest;
            obj.reload(strObj);
        end
    end
end
