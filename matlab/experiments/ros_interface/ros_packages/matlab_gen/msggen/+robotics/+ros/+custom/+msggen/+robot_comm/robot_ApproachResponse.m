classdef robot_ApproachResponse < robotics.ros.Message
    %robot_ApproachResponse MATLAB implementation of robot_comm/robot_ApproachResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_ApproachResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_ApproachResponse(msg)
            %robot_ApproachResponse Construct the message object robot_ApproachResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_ApproachResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'robot_ApproachResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_ApproachResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_ApproachResponse;
            obj.reload(strObj);
        end
    end
end
