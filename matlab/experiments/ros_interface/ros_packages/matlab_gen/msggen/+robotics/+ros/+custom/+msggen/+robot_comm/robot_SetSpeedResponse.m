classdef robot_SetSpeedResponse < robotics.ros.Message
    %robot_SetSpeedResponse MATLAB implementation of robot_comm/robot_SetSpeedResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetSpeedResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_SetSpeedResponse(msg)
            %robot_SetSpeedResponse Construct the message object robot_SetSpeedResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetSpeedResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'robot_SetSpeedResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetSpeedResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetSpeedResponse;
            obj.reload(strObj);
        end
    end
end
