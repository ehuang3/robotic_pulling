classdef robot_SetCommResponse < robotics.ros.Message
    %robot_SetCommResponse MATLAB implementation of robot_comm/robot_SetCommResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetCommResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_SetCommResponse(msg)
            %robot_SetCommResponse Construct the message object robot_SetCommResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetCommResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'robot_SetCommResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetCommResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetCommResponse;
            obj.reload(strObj);
        end
    end
end
