classdef mocap_SetObjTransformationRequest < robotics.ros.Message
    %mocap_SetObjTransformationRequest MATLAB implementation of mocap/mocap_SetObjTransformationRequest
    ...
    properties (Constant)
        MessageType = 'mocap/mocap_SetObjTransformationRequest' % The ROS message type
    end
    ...
    methods
        function obj = mocap_SetObjTransformationRequest(msg)
            %mocap_SetObjTransformationRequest Construct the message object mocap_SetObjTransformationRequest
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetObjTransformationRequest', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetObjTransformationRequest', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetObjTransformationRequest', 'Z');
        ...
        function set.Q0(obj, q0)
            ...
            validateattributes(q0, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetObjTransformationRequest', 'Q0');
        ...
        function set.Qx(obj, qx)
            ...
            validateattributes(qx, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetObjTransformationRequest', 'Qx');
        ...
        function set.Qy(obj, qy)
            ...
            validateattributes(qy, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetObjTransformationRequest', 'Qy');
        ...
        function set.Qz(obj, qz)
            ...
            validateattributes(qz, {'numeric'}, {'nonempty', 'scalar'}, 'mocap_SetObjTransformationRequest', 'Qz');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.mocap.mocap_SetObjTransformationRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.mocap.mocap_SetObjTransformationRequest;
            obj.reload(strObj);
        end
    end
end
