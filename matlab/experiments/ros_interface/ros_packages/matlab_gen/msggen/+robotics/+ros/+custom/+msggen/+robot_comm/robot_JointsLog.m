classdef robot_JointsLog < robotics.ros.Message
    %robot_JointsLog MATLAB implementation of robot_comm/robot_JointsLog
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_JointsLog' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'e43545bd887764ea54a3485cacb46e45' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Date', 'J1', 'J2', 'J3', 'J4', 'J5', 'J6', 'Time', 'TimeStamp'} % List of non-constant message properties
        ROSPropertyList = {'date', 'j1', 'j2', 'j3', 'j4', 'j5', 'j6', 'time', 'timeStamp'} % List of non-constant ROS message properties
    end
    
    methods
        function obj = robot_JointsLog(msg)
            %robot_JointsLog Construct the message object robot_JointsLog
        ...
        function set.Date(obj, date)
            ...
            validateattributes(date, {'char'}, {}, 'robot_JointsLog', 'Date');
        ...
        function set.Time(obj, time)
            ...
            validateattributes(time, {'char'}, {}, 'robot_JointsLog', 'Time');
        ...
        function set.TimeStamp(obj, timestamp)
            ...
            validateattributes(timestamp, {'numeric'}, {'nonempty', 'scalar'}, 'robot_JointsLog', 'TimeStamp');
        ...
        function set.J1(obj, j1)
            ...
            validateattributes(j1, {'numeric'}, {'nonempty', 'scalar'}, 'robot_JointsLog', 'J1');
        ...
        function set.J2(obj, j2)
            ...
            validateattributes(j2, {'numeric'}, {'nonempty', 'scalar'}, 'robot_JointsLog', 'J2');
        ...
        function set.J3(obj, j3)
            ...
            validateattributes(j3, {'numeric'}, {'nonempty', 'scalar'}, 'robot_JointsLog', 'J3');
        ...
        function set.J4(obj, j4)
            ...
            validateattributes(j4, {'numeric'}, {'nonempty', 'scalar'}, 'robot_JointsLog', 'J4');
        ...
        function set.J5(obj, j5)
            ...
            validateattributes(j5, {'numeric'}, {'nonempty', 'scalar'}, 'robot_JointsLog', 'J5');
        ...
        function set.J6(obj, j6)
            ...
            validateattributes(j6, {'numeric'}, {'nonempty', 'scalar'}, 'robot_JointsLog', 'J6');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_JointsLog.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_JointsLog;
            obj.reload(strObj);
        end
    end
end
