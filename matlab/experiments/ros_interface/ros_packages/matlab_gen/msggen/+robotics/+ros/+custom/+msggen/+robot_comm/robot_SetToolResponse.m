classdef robot_SetToolResponse < robotics.ros.Message
    %robot_SetToolResponse MATLAB implementation of robot_comm/robot_SetToolResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetToolResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_SetToolResponse(msg)
            %robot_SetToolResponse Construct the message object robot_SetToolResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetToolResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'robot_SetToolResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetToolResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetToolResponse;
            obj.reload(strObj);
        end
    end
end
