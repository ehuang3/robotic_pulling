classdef robot_SetCartesianJRequest < robotics.ros.Message
    %robot_SetCartesianJRequest MATLAB implementation of robot_comm/robot_SetCartesianJRequest
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetCartesianJRequest' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetCartesianJRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetCartesianJRequest;
            obj.reload(strObj);
        end
    end
end
