classdef robot_SetCartesianRequest < robotics.ros.Message
    %robot_SetCartesianRequest MATLAB implementation of robot_comm/robot_SetCartesianRequest
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetCartesianRequest' % The ROS message type
    end
    ...
    methods
        function obj = robot_SetCartesianRequest(msg)
            %robot_SetCartesianRequest Construct the message object robot_SetCartesianRequest
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetCartesianRequest', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetCartesianRequest', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetCartesianRequest', 'Z');
        ...
        function set.Q0(obj, q0)
            ...
            validateattributes(q0, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetCartesianRequest', 'Q0');
        ...
        function set.Qx(obj, qx)
            ...
            validateattributes(qx, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetCartesianRequest', 'Qx');
        ...
        function set.Qy(obj, qy)
            ...
            validateattributes(qy, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetCartesianRequest', 'Qy');
        ...
        function set.Qz(obj, qz)
            ...
            validateattributes(qz, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetCartesianRequest', 'Qz');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetCartesianRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetCartesianRequest;
            obj.reload(strObj);
        end
    end
end
