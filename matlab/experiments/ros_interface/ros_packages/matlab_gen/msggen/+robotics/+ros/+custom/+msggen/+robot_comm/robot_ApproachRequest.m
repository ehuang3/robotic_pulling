classdef robot_ApproachRequest < robotics.ros.Message
    %robot_ApproachRequest MATLAB implementation of robot_comm/robot_ApproachRequest
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_ApproachRequest' % The ROS message type
    end
    ...
    methods
        function obj = robot_ApproachRequest(msg)
            %robot_ApproachRequest Construct the message object robot_ApproachRequest
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'robot_ApproachRequest', 'Pose');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_ApproachRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_ApproachRequest;
            obj.reload(strObj);
        end
    end
end
