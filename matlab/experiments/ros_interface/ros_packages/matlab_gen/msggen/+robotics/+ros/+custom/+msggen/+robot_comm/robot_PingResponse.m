classdef robot_PingResponse < robotics.ros.Message
    %robot_PingResponse MATLAB implementation of robot_comm/robot_PingResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_PingResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_PingResponse(msg)
            %robot_PingResponse Construct the message object robot_PingResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_PingResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char'}, {}, 'robot_PingResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_PingResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_PingResponse;
            obj.reload(strObj);
        end
    end
end
