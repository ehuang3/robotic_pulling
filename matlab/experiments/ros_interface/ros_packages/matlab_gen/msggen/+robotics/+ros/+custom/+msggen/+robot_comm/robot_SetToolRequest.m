classdef robot_SetToolRequest < robotics.ros.Message
    %robot_SetToolRequest MATLAB implementation of robot_comm/robot_SetToolRequest
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetToolRequest' % The ROS message type
    end
    ...
    methods
        function obj = robot_SetToolRequest(msg)
            %robot_SetToolRequest Construct the message object robot_SetToolRequest
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetToolRequest', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetToolRequest', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetToolRequest', 'Z');
        ...
        function set.Q0(obj, q0)
            ...
            validateattributes(q0, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetToolRequest', 'Q0');
        ...
        function set.Qx(obj, qx)
            ...
            validateattributes(qx, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetToolRequest', 'Qx');
        ...
        function set.Qy(obj, qy)
            ...
            validateattributes(qy, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetToolRequest', 'Qy');
        ...
        function set.Qz(obj, qz)
            ...
            validateattributes(qz, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetToolRequest', 'Qz');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetToolRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetToolRequest;
            obj.reload(strObj);
        end
    end
end
