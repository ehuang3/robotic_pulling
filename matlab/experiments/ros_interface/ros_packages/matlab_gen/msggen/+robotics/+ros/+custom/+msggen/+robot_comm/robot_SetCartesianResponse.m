classdef robot_SetCartesianResponse < robotics.ros.Message
    %robot_SetCartesianResponse MATLAB implementation of robot_comm/robot_SetCartesianResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetCartesianResponse' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetCartesianResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetCartesianResponse;
            obj.reload(strObj);
        end
    end
end
