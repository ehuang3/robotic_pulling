...
center of pressure $[x_0, y_0]$. Note, as written, Algorithm
\ref{alg:angular-velocity-bounds} checks the feasibility of an angular
velocity with respect to $\mathcal{C}$. Now, suppose we had a convex
subclass $\mathcal{K}$ of pressure distributions such that
$\mathcal{K} \subset \mathcal{C}$. We can setup an alternative
