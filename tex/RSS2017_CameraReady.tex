...
orientation bounds. Subsection \ref{sec:stable-equil-when} proves the
existence and uniqueness of the stable equilibrium during
pulling. These last two subsections build the machinery needed to plan
robotic pulling trajectories with convergence guarantees
