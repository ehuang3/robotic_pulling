...
Modeling and contending with uncertainty is a fundamental challenge in robotic
manipulation. Uncertainty can arise from numerous sources including
...
Our ultimate goal is manipulation, and stability alone is not a sufficient for stable planning. % to enable planning to guarantee convergence. 
