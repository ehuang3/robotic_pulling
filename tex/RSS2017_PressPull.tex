...
\begin{inparaenum}
\item 
\item Subsection \ref{sec:diff-dynam-progr} 
\end{inparaenum}

The 

In this section, the materials  are synthesized into 

It is a synthesis of the material in Sections \ref{sec:background} and
\ref{sec:theory}.
