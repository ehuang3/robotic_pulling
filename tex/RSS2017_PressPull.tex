...
used for jointly reasoning about pressure and frictional torques. This
construct is particularly relevant for Subsection
\ref{sec:point-in-moment-hull}, which introduces an algorithm that
...
\end{equation}
to zero. When equation \ref{eq:L-grad-zero} is written element-wise,
we end up with the following first order conditions on the force and
the moment % \BB{Maybe add the derivation of
