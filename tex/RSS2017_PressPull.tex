...
point \cite{Mason}. An example frictional moment envelope illustrated
in Figure \ref{fig:moment-envelope}.
...
the existence and uniqueness of a stable equilibrium when pulling an
object. These last two subsections are mainly to establish convergence
guarantees for robotic pulling trajectories.
...
\EH{TODO: Simplify proof. Should be like two lines.}
...
\EH{TODO: Add quick corollary on Lyapunov stability.}
...
%     \centering
%     \includegraphics[width=0.8\textwidth]{fig/good_trajectory.eps}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.5\textwidth}
%     \centering
%     \includegraphics[width=0.8\textwidth]{fig/bad_trajectory.eps}
%   \end{subfigure}
% \caption{}
