...
Out of one hundred experiments attempted, 23 experiments were discarded due to either the workspace constraint or high detection uncertainty in the vision system.
The remaining 77 experiments yielded an average distance error of 3.9mm (standard deviation:2.6mm) and an angular error of 5.9 degrees (standard deviation: 6.16 degrees). Note that these errors are computed in a frame centered at the object center and not at the contact point.
