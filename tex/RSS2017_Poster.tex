...
\documentclass[landscape,paperwidth=42in,paperheight=32in,margin=1.5in,fontscale = 0.32]{baposter} % Adjust the font scale/size here
...
\headerbox{Exact Angular Velocity Bounds}{name=ex,column=1,row=0}{
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      {\includegraphics[width=0.7\columnwidth]{fig/omega_bounds_2}};
      ...
      \end{scope}
    \end{tikzpicture}
    % {\centering\includegraphics[width=0.5\columnwidth]{fig/omega_bounds_2}}
  \end{center}
...
\headerbox{Robotic Pulling Planner}{name=pl,column=1,below=ex,bottomaligned=bg}{\vspace{3mm}
...
\headerbox{Experiments}{name=exp,column=2,row=0}{
  \begin{tabular}{@{}cc@{}}
    \multicolumn{1}{m{0.45\columnwidth}}{\includegraphics[width=0.5\columnwidth]{fig/hardware.png}} & \multicolumn{1}{m{0.45\columnwidth}}{\includegraphics[width=0.5\columnwidth]{fig/trajectory_2.eps}}
  ...
  work}{name=fw,column=2,below=exp}{
  \begin{itemize}
  \item Apply the exact bounds to real-world robotics problems such as
    NAMO, tabletop rearrangement planning.
  \end{itemize}
} \headerbox{Conclusion}{name=con,column=2,below=fw}{
...
\headerbox{References}{name=ref,column=2,below=con}{
  \scriptsize{
    \bibliographystyle{plain}
    \bibliography{references}
  }
}
\headerbox{Acknowledgements}{name=ack,column=2,below=ref,bottomaligned=pl}{
  \scriptsize{
